...
class Bot:
    def __init__(self, id_cliente='', data_aniversario='', sexo='', rep='', telefone='', email='', loja='', minuta='', pedido='', data_compra='', mes='', ano='', valor_mercadoria='', nce='', sub_grupo='', mercadoria='', rota='', bairro='', cidade='', uf='', zona='', tp_residencia=''):
    ...
    def show_info(self):
        ...
        print(self.id_cliente, self.data_aniversario, self.sexo, self.rep, self.telefone, self.email, self.loja, self.minuta, self.pedido, self.data_compra, self.mes, self.ano, self.valor_mercadoria, self.nce, self.sub_grupo, self.mercadoria, self.rota, self.bairro, self.cidade, self.uf, self.zona, self.tp_residencia)

    def gravar_dados(self):
        conexao = mysql.connector.connect(db='db_ucase', user='root', passwd='')
        cursor = conexao.cursor()
        cursor.execute("INSERT INTO tb_bot (cd_cliente, dt_aniversario, sexo, rep, telefone, email, loja, minuta, pedido, dt_compra, mes, ano, vl_mercadoria, nce, sub_grupo, mercadoria, rota, bairro, cidade, uf, zona, tp_residencia) values('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')".format(self.id_cliente, self.data_aniversario, self.sexo, self.rep, self.telefone, self.email, self.loja, self.minuta, self.pedido, self.data_compra, self.mes, self.ano, self.valor_mercadoria, self.nce, self.sub_grupo, self.mercadoria, self.rota, self.bairro, self.cidade, self.uf, self.zona, self.tp_residencia))
        print ('-------------------------------------------------------------------------------------------------------------------------------------------------------------------------')
        conexao.commit()
        conexao.close()